      ...
      <div className="space-y-4">
        ...
        {isLoading ? (
          ...
          <div className="py-16 text-center bg-slate-900 rounded-3xl border border-slate-800">
            ...
            <h4 className="text-sm font-bold text-white">No Notifications Sent Yet</h4>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-800 bg-slate-950/60 text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">
                    <th className="px-3.5 py-3">Title & Message</th>
                      ...
                      <td className="px-3.5 py-3">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div className="min-w-0">
                            <div className="font-black text-slate-900 dark:text-white text-xs leading-snug truncate max-w-[200px]">{n.title}</div>
                            <div className="text-[10px] text-slate-500 dark:text-slate-400 truncate max-w-[200px]">{n.message}</div>
                          </div>
                        </div>
                      </td>
